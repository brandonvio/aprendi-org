...
// ParseEnrollment translates a models.OrganizationData to an Enrollment
func (er *EnrollmentRepo) ParseEnrollment(data *models.OrganizationData) (*Enrollment, error) {
