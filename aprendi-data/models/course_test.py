...
def test_course_crud_operations():
    ...
    """
    # 1. Save a course
    course = CourseModel(id="100", org_id="test_org_1", course_name="Mathematics", description="Introduction to Algebra", section="101A")
    ...
    assert fetched_course.course_name == "Mathematics"
    ...
    assert courses[0].course_name == "Mathematics"
